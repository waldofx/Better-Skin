      ...
      <div class="container-fluid">
        <section id="section1">
          <div class="mt-5 mb-5" alt="Responsive Image">
            <img id="promo" src="bg1.png" class="rounded"></img>
          </div>
          ...
          <div id="hot">
            <img src="bg2.png" class="w-5shadow-1-strong rounded px-5 py-5" />

            <img src="bg3.png" class="w-5 shadow-1-strong rounded px-5 py-5" />

            <img src="bg10.png" class="w-5 shadow-1-strong rounded px-5 py-5" />
          </div>
          ...
          <div class="mt-5 mb-5" alt="Responsive Image">
            <img id="model" src="bg5.png" class="rounded"></img>
          </div>
        </section>
        <section>
          ...
          <div class="row row-cols-1 row-cols-md-4 g-4 px-5 py-5">
            <div class="col">
              <div class="card h-100">
                <img src="bg6.png" class="card-img-top" />
                <div class="card-body">
            ...
            <div class="col">
              <div class="card h-100">
                <img src="bg7.png" class="card-img-top" />
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center mt-2 mb-2">
            ...
            <div class="col">
              <div class="card h-100">
                <img src="bg9.png" class="card-img-top" />
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center mt-2 mb-2">
